...
describe('Rating service', () => {
  ...
  describe('Calculate rating for a given point', () => {
    ...
    it('should get a rating 3 for a point with offshore winds and a half overhead height', () => {
      const point = {
        ...defaultPoint,
  ...
  describe('Get rating based on wind and wave positions', () => {
    ...
    it('shoul get rating 3 for a beach with cross winds', () => {
      const rating = defaultRating.getRatingBasedOnWindAndWavePosition(
        GeoPosition.E,
        GeoPosition.S
      );
    ...
    it('shoudl get rating 5 for a beach with offshore winds', () => {
      const rating = defaultRating.getRatingBasedOnWindAndWavePosition(
        GeoPosition.E,
        GeoPosition.W
      );
  ...
  describe('Get position based on position location', () => {
    //medidas em graus
    ...
    it('should get the position based on a west location', () => {
